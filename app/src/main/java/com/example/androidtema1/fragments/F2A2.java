...
public class F2A2 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button button1 = view.findViewById(R.id.f2a2_button1);
        Button button2 = view.findViewById(R.id.f2a2_button2);
        Button button3 = view.findViewById(R.id.f2a2_button3);
